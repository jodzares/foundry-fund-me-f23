...
contract FundMeTest is Test {
    ...
    function testAdds2ndFundertoArrayofFunders() public {
        vm.prank(USER);
        fundMe.fund{value: SEND_VALUE}();
        vm.prank(SECOND_USER);
        fundMe.fund{value: SEND_VALUE - 0.05 ether}();
        address secondFunder = fundMe.getFunder(1);
        uint256 amountFunded2nd = fundMe.getAddressToAmountFunded(SECOND_USER);
        assertEq(secondFunder, SECOND_USER);
        assertEq(amountFunded2nd, SEND_VALUE - 0.05 ether);
    }
